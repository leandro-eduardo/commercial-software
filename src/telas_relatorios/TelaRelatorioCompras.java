 ...
 * @author leand
 */
public class TelaRelatorioCompras extends javax.swing.JInternalFrame {

    public static TelaRelatorioCompras tela;
    ...
    public static TelaRelatorioCompras getTela() {  //Estático para poder ser chamado de outras classes sem a necessidade de ter criado um objeto anteriormente.
        if (tela == null) {   //Tela não está aberta, pode criar uma nova tela
            tela = new TelaRelatorioCompras();
    ...
    private void initComponents() {
        ...
        jComboBoxSituacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todas", "Pedido Aberto", "Pedido Cancelado", "Compra Finalizada", "Compra Cancelada" }));
        ...
        jComboBoxOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Fornecedor", "Data", "Nº Itens", "Situação", "Valor Total" }));
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(jLabelCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
                                        .addComponent(jLabelPessoa, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    .addGap(5, 5, 5)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                .addComponent(jTextFieldCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 350, Short.MAX_VALUE)
                ...
                public void run() {
                    try {
                        ...
                        if (jRadioButtonSintetico.isSelected()) {
                            ...
                            //String caminhoRelatorio = System.getProperty("user.dir") + "/JasperReports/RelatorioComprasSintetico.jasper";/*"C:\\Users\\leand\\JaspersoftWorkspace\\MyReports\\RelatorioProdutos.jasper";*/

                            //Caminho relativo
                            InputStream caminhoRelatorio = getClass().getResourceAsStream("/relatorios/RelatorioComprasSintetico.jasper");
                            ...
                            String parametro = "SELECT COMPRA.ID, COMPRA.DATA, COMPRA.valortotal, COMPRA.desconto, COMPRA.valorliquido, COMPRA.status,\n"
                                    + "PESSOA.nomerazaosocial AS FORNECEDOR,\n"
                                    + "(SELECT COUNT(IC.quantidade)\n"
                                    + "FROM ITEMCOMPRA IC\n"
                                    + "INNER JOIN PRODUTO P ON P.ID = IC.IDPRODUTO\n"
                                    + "INNER JOIN COMPRA C ON C.ID = IC.IDCOMPRA\n"
                                    + "WHERE IC.IDCOMPRA = COMPRA.ID) AS QTDEITENS\n"
                                    + "FROM COMPRA\n"
                                    + "INNER JOIN PESSOA AS PESSOA ON COMPRA.IDPESSOA = PESSOA.ID WHERE ";

                            if (!jTextFieldCodigo.getText().trim().isEmpty()) {
                                parametro = parametro + "COMPRA.ID IN (" + jTextFieldCodigo.getText() + ") AND ";
                            }

                            if (!jTextFieldPessoa.getText().trim().isEmpty()) {
                                parametro = parametro + "COMPRA.IDPESSOA IN (" + jTextFieldPessoa.getText() + ") AND ";
                            }

                            if (jDateChooserDataInicial.getDate() == null) {
                                parametro = parametro + "COMPRA.DATA BETWEEN '01.01.1900' AND ";
                            } else {
                                parametro = parametro + "COMPRA.DATA BETWEEN '" + new SimpleDateFormat("dd.MM.yyyy").format(jDateChooserDataInicial.getDate()) + "' AND ";
                            }
                            ...
                            switch (jComboBoxSituacao.getSelectedIndex()) {
                                case 0:
                                    parametro = parametro + "COMPRA.STATUS IN ('PA', 'PC', 'CF', 'CC') AND ";
                                    break;
                                case 1:
                                    parametro = parametro + "COMPRA.STATUS IN ('PA') AND ";
                                    break;
                                case 2:
                                    parametro = parametro + "COMPRA.STATUS IN ('PC') AND ";
                                    break;
                                case 3:
                                    parametro = parametro + "COMPRA.STATUS IN ('CF') AND ";
                                    break;
                                case 4:
                                    parametro = parametro + "COMPRA.STATUS IN ('CC') AND ";
                                    break;
                            }
                            ...
                            switch (jComboBoxOrdenar.getSelectedIndex()) {
                                case 0:
                                    parametro = parametro + " ORDER BY COMPRA.ID";
                                    break;
                                case 1:
                                    parametro = parametro + " ORDER BY FORNECEDOR";
                                    break;
                                case 2:
                                    parametro = parametro + " ORDER BY COMPRA.DATA";
                                    break;
                                case 3:
                                    parametro = parametro + " ORDER BY QTDEITENS";
                                    break;
                                case 4:
                                    parametro = parametro + " ORDER BY COMPRA.STATUS";
                                    break;
                                case 5:
                                    parametro = parametro + " ORDER BY COMPRA.VALORLIQUIDO";
                                    break;
                            }
                            ...
                            //Imprimindo o relatório
                            //Caminho absoluto comentado para utilizar o caminho relativo que pega os arquivo da pasta src do projeto
                            //String caminhoRelatorio = System.getProperty("user.dir") + "/JasperReports/RelatorioComprasAnalitico.jasper";/*"C:\\Users\\leand\\JaspersoftWorkspace\\MyReports\\RelatorioProdutos.jasper";*/

                            //Caminho relativo
                            InputStream caminhoRelatorio = getClass().getResourceAsStream("/relatorios/RelatorioComprasAnalitico.jasper");
                            JasperPrint jasperPrint = null;
                            ...
                            //Passando parâmetros e convertendo os dados pra ser compativel
                            String parametro = "SELECT COMPRA.ID, COMPRA.DATA, COMPRA.valortotal, COMPRA.desconto, COMPRA.valorliquido, COMPRA.status,\n"
                                    + "COMPRA.idpessoa, PESSOA.nomerazaosocial AS FORNECEDOR, PESSOA.ENDERECO, PESSOA.NUMERO, PESSOA.COMPLEMENTO,\n"
                                    + "PESSOA.CPFCNPJ, PESSOA.CEP, PESSOA.FONE1 AS CELULAR, PESSOA.FONE2 AS TELEFONE, CIDADE.NOME AS CIDADE, ESTADO.SIGLA,\n"
                                    + "condicaopagamento.id AS IDCONGPAGTO, condicaopagamento.descricao AS CONDPAGTODESC, (SELECT COUNT(IV.quantidade)\n"
                                    + "FROM ITEMCOMPRA IV\n"
                                    + "INNER JOIN PRODUTO P ON P.ID = IV.IDPRODUTO\n"
                                    + "INNER JOIN COMPRA C ON C.ID = IV.IDCOMPRA\n"
                                    + "WHERE IV.IDCOMPRA = COMPRA.ID) AS QTDEITENS\n"
                                    + "FROM COMPRA\n"
                                    + "INNER JOIN PESSOA AS PESSOA ON COMPRA.IDPESSOA = PESSOA.ID\n"
                                    + "INNER JOIN CIDADE ON CIDADE.ID = PESSOA.IDCIDADE\n"
                                    + "INNER JOIN ESTADO ON ESTADO.ID = CIDADE.IDESTADO\n"
                                    + "INNER JOIN CONDICAOPAGAMENTO ON CONDICAOPAGAMENTO.ID = COMPRA.IDCONDICAOPAGAMENTO WHERE ";
                            ...
                            switch (jComboBoxOrdenar.getSelectedIndex()) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    parametro = parametro + " ORDER BY COMPRA.VALORLIQUIDO DESC";
                                    break;
                            }
                            ...
                            URL caminhoSubRelatorio = getClass().getResource("/relatorios/subrelatorios/SubRelatorioItensCompra.jasper");
                        ...
                        Logger.getLogger(TelaRelatorioCompras.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void jButtonConsultaCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultaCodigoActionPerformed
        new TelaConsultaFiltro(parametrosConsulta = new ParametrosConsulta("Consulta de Compra para Relatório",
