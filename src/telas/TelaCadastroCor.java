...
public class TelaCadastroCor extends TelaCadastro {
    ...
    public TelaCadastroCor() {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/cor.png")));
        //painelStatus
    ...
    public void setPersistencia() {
        ...
        cor.setNome(campoNome.getText());
        cor.setAtivo(campoAtivo.getValor());
    }

    public void getPersistencia() {
        campoCodigo.setValor(cor.getId());
        campoNome.setText(cor.getNome());
    ...
    public boolean incluirBD() {
        setPersistencia();
        boolean retorno = daoCor.incluir();
        getPersistencia();
        return retorno;
    }
    ...
    public void consultar() {
        super.consultar();
        new TelaConsultaFiltro(parametrosConsulta = new ParametrosConsulta("Consulta de Cor",
                DaoCor.SQLPESQUISAR,
