...
public class TabelaItemVenda extends JPanel implements MeuComponente {
    private JScrollPane jsp = new JScrollPane();
    public static TableModelItemVenda tmi = new TableModelItemVenda();
    public static JTable tabela = new JTable(tmi) {
        @Override
...
//        add(botaoAdicionar);
//        add(botaoRemover);
//        botaoAdicionar.addActionListener(new ActionListener() { //removidos os botões adicionar e remover do lado da tabela e adicionados ao dentro do painel do item
//            @Override
...
//        });
    ...
    public void setValor(Object valor) {
        tmi.setDados((List<ItemVenda>) valor);
    }
    ...
    public TableModelItemVenda getTableModel() {
        return tmi;
    }
